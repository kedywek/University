...
#define AMOUNT_OF_PRONGS 7
#define AMOUNT_OF_DISKS 5
#define GROUND_HEIGHT 50
#define PRONG_HEIGHT 350
#define HALF_WIDTH_OF_PRONG 5
#define DISC_HEIGHT (PRONG_HEIGHT / (AMOUNT_OF_DISKS + 1))
#define STEP 5
...
int animationdowntoup(int x, int ystart, int size, Prong prongs[])
{
	...
	int halfdisc =
		gfx_screenWidth() / (AMOUNT_OF_PRONGS + 1) / (AMOUNT_OF_DISKS + 1) / 2;
...
{	
	gfx_filledRect(
		...
		x + size,
		gfx_screenHeight() - GROUND_HEIGHT - (y + DISC_HEIGHT) - 2, BLUE);
